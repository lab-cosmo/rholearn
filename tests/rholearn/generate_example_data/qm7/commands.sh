...
# Run RI rebuild
# python -c 'from rholearn.aims_interface import ri_rebuild; from dft_settings import DFT_SETTINGS; from hpc_settings import HPC_SETTINGS; ri_rebuild.run_ri_rebuild(DFT_SETTINGS, HPC_SETTINGS);'
